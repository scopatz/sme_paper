...
% Text of abstract
\begin{abstract}
Matched abundance ratio cascades are well-known way of computing concentraions
and flow rates for multicomponent enrichment.  Due to the form of the system 
of equations, these are often solved using standard contrained numerical 
optimizers.  Here a symbolic mathematics libarary (SymPy) is coupled with 
...
occassionally more, accuracy as the cooresponding numeric optimizer.  The 
