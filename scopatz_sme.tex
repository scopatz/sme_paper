...
in the sense that it requires 31 operations to as opposed to the 38 in 
equation \ref{nt_closed_full}.  More importantly, $N_P$ appears only once in this 
...
Figure \ref{nt_closed_fig} confirms that the closed form $N_T(N_P, M^*)$ is coreect.
This 
