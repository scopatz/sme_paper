...
$\alpha$, $M_i$ for all $i$, $x_i^F$ for all $i$, $j$ (e.g. \nuc{U}{235}), $k$ 
(e.g. \nuc{U}{238}), the key target product enrichment $x_j^P$, and the key target 
...
when evaluated for the \jth key component, whose target product erichment is assumed
